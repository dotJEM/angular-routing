...
interface ISyntaxHighlightService {
    Highlight(elm);
}
angular.module('dotjem.routing.pages').service('syntax', [<any>'scriptLoader',
    function (scriptLoader): ISyntaxHighlightService {
        var $service: any = {};
        var brushmapping = {};
        ...
        function push(file: string, ...args: string[]) {
        ...
        function parseParams(str): any {
            ...
            while ((match = regex.exec(str)) != null) {
                ...
                if (value != null && arrayRegex.test(value)) {
                    var m: { values:any }  = arrayRegex.exec(value);
