...
describe('state.stateComparer', function () {
    ...
    describe('path', function () {
        it('different trees', function () {
            ...
            var result = comparer.path({ fullname: '$root.left.branch', parent: { fullname: '$root.left', parent: root } }, { fullname: '$root.right.branch', parent: { fullname: '$root.right', parent: root } }, {}, {});
        ...
        it('different branches unchanged holds common ancestors', function () {
            ...
            var result = comparer.path({ fullname: '$root.branch.left', parent: branch }, { fullname: '$root.branch.right', parent: branch }, {}, {});

            expect(result.unchanged[0]).toHaveProperties({ active: true, changed: false, name: '$root.branch', params: {} });
        });
        ...
        it('different branches with changed parameter on common ancestor', function () {
            ...
            var result = comparer.path({ fullname: '$root.branch.left', parent: branch }, { fullname: '$root.branch.right', parent: branch }, { foo: 1 }, { foo: 2 });
        ...
        it('different branches with changed parameter on common ancestor without reloading on parameter changes', function () {
            ...
            var result = comparer.path({ fullname: '$root.branch.left', parent: branch }, { fullname: '$root.branch.right', parent: branch }, { foo: 1, bar: 'bob' }, { foo: 1, bar: 'mar' });
        ...
        it('different branches with changed parameter on common ancestor without reloading on parameter changes', function () {
            ...
            var result = comparer.path({ fullname: '$root.branch.left', parent: branch }, { fullname: '$root.branch.right', parent: branch }, { foo: 1, bar: 'bob', $search: { bar: 'bob' } }, { foo: 1, bar: 'mar', $search: { bar: 'mar' } });
        ...
        it('parameter changes sets paramChanges true', function () {
            ...
            var result = comparer.path({ fullname: '$root.branch.right', parent: branch }, { fullname: '$root.branch.right', parent: branch }, { foo: 1 }, { foo: 2 });
        ...
        it('different branches with unchanged parameter on common ancestor', function () {
            ...
            var result = comparer.path({ fullname: '$root.branch.left', parent: branch }, { fullname: '$root.branch.right', parent: branch }, { foo: 1 }, { foo: 1 });
        ...
        it('applying force gives changes from the fourced state', function () {
            ...
            var result = comparer.path({ fullname: '$root.branch.left', parent: branch }, { fullname: '$root.branch.left', parent: branch }, { foo: 1 }, { foo: 1 }, { force: '$root.branch' });
        ...
        it('applying force in different branches gives changes from the fourced state', function () {
            ...
            var result = comparer.path({ fullname: '$root.branch.left', parent: branch }, { fullname: '$root.branch.right', parent: branch }, { foo: 1, search: 'foo' }, { foo: 1, search: 'bar' }, { force: '$root.branch' });
        ...
        it('applying force overrules reloadOnOptional', function () {
            ...
            var result = comparer.path({ fullname: '$root.branch.left', parent: branch }, { fullname: '$root.branch.right', parent: branch }, { foo: 1 }, { foo: 1 }, { force: '$root.branch' });
        ...
        it('provides leaf information when we navigate up', function () {
            ...
            var result = comparer.path({ fullname: '$root.branch.left', parent: branch }, branch, {}, {});
