...
describe('$routeProvider.templateDecorator', function () {
    ...
    it('should allow using a function as a template', function () {
        ...
        function customTemplateFn(routePathParams) {
            ...
            expect(routePathParams).toEqual({
                id: 'id3'
            });
        ...
        mock.module(function ($routeProvider) {
            ...
            $routeProvider.when('/foo/:id', {
                template: customTemplateFn
            });
        });
        mock.inject(function ($route, $location, $rootScope) {
            $location.path('/foo/id3');
            $rootScope.$digest();
            expect(customTemplateWatcher).toHaveBeenCalledWith({
                id: 'id3'
            });
        });
    });
    it('should allow using a function as a templateUrl', function () {
        ...
        mock.module(function ($routeProvider) {
            ...
            $routeProvider.when('/foo/:id', {
                templateUrl: customTemplateUrlFn
            });
        });
        mock.inject(function ($route, $location, $rootScope) {
            $location.path('/foo/id3');
            $rootScope.$digest();
            expect(customTemplateUrlWatcher).toHaveBeenCalledWith({
                id: 'id3'
            });
    ...
    describe('redirection', function () {
        ...
        it('should replace the url when redirecting', function () {
            ...
            mock.inject(function ($browser, $route, $location, $rootScope) {
                ...
                expect($browserUrl.calls[3].args).toEqual([
