...
describe('$routeProvider.templateDecorator', function () {
    ...
    it('should allow using a function as a template', function () {
        ...
        mock.inject(function ($route, $location, $rootScope) {
    ...
    it('should not change route when location is canceled', function () {
        ...
        mock.inject(function ($route, $location, $rootScope, $log) {
    ...
    describe('should match a route that contains special chars in the path', function () {
        beforeEach(mock.module(function ($routeProvider) {
            $routeProvider.when('/$test.23/foo*(bar)/:baz', { templateUrl: 'test.html' });
        }));

        it('matches the full path', function () {
            mock.inject(function ($route, $location, $rootScope) {
                $location.path('/test');
                $rootScope.$digest();
        ...
        it('treats backslashes normally', function () {
            mock.inject(function ($route, $location, $rootScope) {
        ...
        it('matches a URL with special chars', function () {
            mock.inject(function ($route, $location, $rootScope) {
                $location.path('/$test.23/foo*(bar)/222');
                $rootScope.$digest();
    ...
    it('should chain whens and otherwise', function () {
        mock.module(function ($routeProvider) {
            $routeProvider.when('/foo', { templateUrl: 'foo.html' }).otherwise({ templateUrl: 'bar.html' }).when('/baz', { templateUrl: 'baz.html' });
        });
    ...
    describe('events', function () {
        ...
        it('should fire $routeChangeStart and resolve promises', function () {
            ...
            mock.module(function ($provide, $routeProvider) {
            ...
            mock.inject(function ($location, $route, $rootScope, $httpBackend) {
                var log = '';
        ...
        it('should fire $routeChangeError event on resolution error', function () {
            ...
            mock.inject(function ($location, $route, $rootScope) {
                var log = '';
        ...
        it('should fetch templates', function () {
            ...
            mock.inject(function ($route, $httpBackend, $location, $rootScope) {
                var log = '';
        ...
        it('should not update $routeParams until $routeChangeSuccess', function () {
            ...
            mock.inject(function ($route, $httpBackend, $location, $rootScope, $routeParams) {
                var log = '';
                $rootScope.$on('$routeChangeStart', function (e, next) {
        ...
        it('should catch local factory errors', function () {
            ...
            mock.module(function ($routeProvider, $exceptionHandlerProvider) {
            ...
            mock.inject(function ($location, $route, $rootScope, $exceptionHandler) {
    ...
    describe('redirection', function () {
        it('should support redirection via redirectTo property by updating $location', function () {
            mock.module(function ($routeProvider) {
                $routeProvider.when('/', { redirectTo: '/foo', x: "/" });
                $routeProvider.when('/foo', { templateUrl: 'foo.html', x: "/foo" });
                $routeProvider.when('/bar', { templateUrl: 'bar.html', x: "/bar" });
                $routeProvider.when('/baz', { redirectTo: '/bar', x: "/baz" });
                $routeProvider.otherwise({ templateUrl: '404.html', x: "/baz" });
            });
        ...
        it('should replace the url when redirecting', function () {
            ...
            mock.inject(function ($browser, $route, $location, $rootScope) {
                var $browserUrl = spyOn($browser, 'url');
                $browserUrl.andCallThrough();
                ...
                expect($browserUrl.calls[3].args).toEqual(['http://server/#/bar/id3?extra=eId', true]);
            });
        });
    });
    ...
    describe('reloadOnSearch', function () {
        it('should reload a route when reloadOnSearch is enabled and .search() changes', function () {
            ...
            mock.inject(function ($route, $location, $rootScope, $routeParams) {
        ...
        it('should not reload a route when reloadOnSearch is disabled and only .search() changes', function () {
            var routeChange = jasmine.createSpy('route change'), routeUpdate = jasmine.createSpy('route update');
        ...
        describe('reload', function () {
            it('should reload even if reloadOnSearch is false', function () {
                ...
                mock.inject(function ($route, $location, $rootScope, $routeParams) {
                    ...
                    expect(routeChangeSpy.callCount).toBe(1);
