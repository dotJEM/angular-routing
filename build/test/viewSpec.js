    ...
    describe("update", function () {
        ...
        it('raises $viewRefresh when sticky tag matches', function () {
            mock.inject(function ($view) {
                ...
                expect(spy.callCount).toBe(2);
                expect(spy.mostRecentCall.args).toEqual(['$viewRefresh', "root", { sticky: "sticky" }]);
            });
        });
    ...
    describe("refresh", function () {
        it('raises $viewRefresh with provided data', function () {
            mock.inject(function ($view) {
                ...
                expect(spy.mostRecentCall.args).toEqual(['$viewRefresh', "root", { $locals: undefined, stuff: "fubar" }]);
            });
        });
        ...
        it('raises $viewRefresh and preserves locals', function () {
            mock.inject(function ($view) {
                ...
                $view.refresh("root", { stuff: "fubar" });
                expect(spy.mostRecentCall.args).toEqual(['$viewRefresh', "root", { $locals: { local: "hello" }, stuff: "fubar" }]);
            });
        });
    });
