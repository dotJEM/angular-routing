...
describe('$routeProvider', function () {
    ...
    describe("when", function () {
        ...
        it('matches no route', function () {
            ...
            mock.inject(function ($route, $location) {
                ...
                var next;
                scope.$on('$routeChangeSuccess', function (event, n) {
                    next = n;
                });
                scope.$digest();
        ...
        it('matches first route with paramter', function () {
            mock.module(function ($routeProvider) {
                $routeProvider.when('/Book/{id}', { message: "bookRoute" }).when('/Customer/{id}', { message: "customerRoute" });
            });
        ...
        it('matches first route with number paramter and converts to number', function () {
            mock.module(function ($routeProvider) {
                $routeProvider.when('/Book/{num:id}', { message: "bookRoute" }).when('/Customer/{num:id}', { message: "customerRoute" });
            });
        ...
        it('matches route when using regex parameter', function () {
            mock.module(function ($routeProvider) {
                $routeProvider.when('/Book/{regex(^\\w{2,5}$):id}', { message: "bookRoute" }).when('/Customer/{id}', { message: "customerRoute" });
            });
        ...
        it('matches no route when parameter is invalid created with object', function () {
            mock.module(function ($routeProvider) {
                $routeProvider.when('/Book/{regex( { "exp" : "^\\\\w{2,5}$", "flags": "i" } ):id}', { message: "bookRoute" }).when('/Customer/{id}', { message: "customerRoute" });
            });
        ...
        it('should be possible to overwrite a route', function () {
            mock.module(function ($routeProvider) {
                $routeProvider.when('/Book', { message: "oldBookRoute" }).when('/Customer', { message: "customerRoute" }).when('/Book', { message: "bookRoute" });
            });
        ...
        it('should be possible to register same route with different parameter types a route', function () {
            mock.module(function ($routeProvider) {
                $routeProvider.when('/Book/{num:param}', { message: "numberBookRoute" }).when('/Book/{param}', { message: "bookRoute" });
            });
        ...
        it('normalize names', function () {
            var converterArgs;
            mock.module(function ($routeProvider) {
                $routeProvider.when('/Book/:param1/:param2', {}).when('/Home/:param3/:param4', {}).when('/Rear/:param3/:param4', {});
            });
        ...
        it('normalized names allow for overwriting routes', function () {
            var converterArgs;
            mock.module(function ($routeProvider) {
                $routeProvider.when('/Book/:param1/:param2', {}).when('/Book/:param3/:param4', {});
            });
        ...
        it('different converters can be used to seperate routes', function () {
            var converterArgs;
            mock.module(function ($routeProvider) {
                $routeProvider.when('/Book/{num:param1}/numbers', {}).when('/Book/{param1}/others', {});
            });
        ...
        it('catch all parameters', function () {
            mock.module(function ($routeProvider) {
                $routeProvider.when('/{*url}', { message: "catchAll" });
            });
        ...
        it('can define more specific routes before catch all', function () {
            mock.module(function ($routeProvider) {
                $routeProvider.when('/Book/{*url}', { message: "bookRoute" }).when('/{*url}', { message: "catchAll" });
            });
    ...
    describe("decorate", function () {
        it('converts message paramter into template parameter', function () {
            mock.module(function ($routeProvider) {
                $routeProvider.when('/Book', { message: "bookRoute" }).when('/Customer', { message: "customerRoute" }).decorate('template', function () {
    ...
    describe("convert", function () {
        it('matches route when custom parameter starts with a', function () {
            mock.module(function ($routeProvider) {
                $routeProvider.when('/Book/{custom:param}', { message: "bookRoute" }).when('/Customer/{custom:param}', { message: "customerRoute" }).convert('custom', function () {
        ...
        it('matches route when custom parameter contains pattern sub', function () {
            mock.module(function ($routeProvider) {
                $routeProvider.when('/Book/{contains(sub):param}', { message: "bookRoute" }).when('/Customer/{contains(sub):param}', { message: "customerRoute" }).convert('contains', function (substring) {
                    return function (param) {
        ...
        it('matches no route when custom parameter contains pattern fubar', function () {
            mock.module(function ($routeProvider) {
                $routeProvider.when('/Book/{contains(fubar):param}', { message: "bookRoute" }).when('/Customer/{contains(fubar):param}', { message: "customerRoute" }).convert('contains', function (substring) {
                    return function (param) {
                        if (param.search(substring) != -1)
                            return true;
                        return false;
        ...
        it('matches no route when custom parameter contains pattern fubar', function () {
            var converterArgs;
            mock.module(function ($routeProvider) {
                $routeProvider.when('/Book/{custom({"name":"John Doe", "age": 42}):param}', { message: "bookRoute" }).convert('custom', function (args) {
                    converterArgs = args;
                    return function (param) {
                        return true;
                    };
        ...
        it('can use catch all with parameters', function () {
            mock.module(function ($routeProvider) {
                $routeProvider.when('/Book/{contains(catch):*param}', { message: "bookRoute" }).when('/Customer/{contains(catch):*param}', { message: "customerRoute" }).convert('contains', function (substring) {
                    return function (param) {
                        if (param.search(substring) != -1)
                            return true;
                        return false;
    ...
    describe("ignoreCase", function () {
        it('matches an uppercase route whit an lowercase location', function () {
            var converterArgs;
            mock.module(function ($routeProvider) {
                $routeProvider.ignoreCase().when('/BOOK', { message: "bookRoute" });
            });
    ...
    describe("format", function () {
        ...
        it('regex converter throws error when values does not match', function () {
            ...
            mock.inject(function ($route) {
                expect(function () {
                    $route.format('/look/{regex([0-9]+):one}', { one: 'invalid' });
                }).toThrow();
            });
        });
        ...
        it('custom converter can define formatting', function () {
            ...
            mock.inject(function ($route) {
                ...
                expect(function () {
                    $route.format('/look/{custom:one}', { one: 4 });
    ...
    describe("change", function () {
        ...
        it('without params changes location', function () {
            var converterArgs;
            mock.module(function ($routeProvider) {
                $routeProvider.when('/book', { message: "bookRoute" }).when('/look', { message: "lookRoute" });
            });
        ...
        it('with params changes location', function () {
            var converterArgs;
            mock.module(function ($routeProvider) {
                $routeProvider.when('/book', { message: "bookRoute" }).when('/book/:id', { message: "bookRouteWithId" }).when('/look', { message: "lookRoute" }).when('/look/:id', { message: "lookRouteWithId" });
            });
