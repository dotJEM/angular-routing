 ...
 */
var $StateProvider = [<any>'$routeProvider', '$stateTransitionProvider', '$pipelineProvider', function ($routeProvider: dotjem.routing.IRouteProvider, $transitionProvider, $pipelineProvider) {
    'use strict';
     ...
     * @returns {Object} self
     */
    this.state = function (nameOrFunc: string, state: dotjem.routing.IState) {
    ...
    function internalRegisterState(fullname: string, state: dotjem.routing.IState) {
