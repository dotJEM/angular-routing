...
#### Latest release v0.4.3:
 - Source: [angular-routing.js](https://raw.github.com/dotJEM/angular-routing/v0.4.3/build/angular-routing.js)
 - Minified: [angular-routing.min.js](https://raw.github.com/dotJEM/angular-routing/v0.4.3/build/angular-routing.min.js)
 - Folder: [Build](https://github.com/dotJEM/angular-routing/tree/v0.4.3/build)
